...
const ABI = "../data/raw/abi-weth-gateway.json";
const PATH_INPUT_DATA = "../data/raw/tx-history-weth-gateway.csv";
const PATH_OUTPUT_DATA = "../data/parsed/tx-history-weth-gateway.csv";
